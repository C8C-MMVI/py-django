...
const styles = `
  ...
  .todo-title span { color: var(--accent); }
  ...
  .checkbox-mark { display: none; width: 12px; height: 12px; stroke: #fff; stroke-width: 3; fill: none; }
  .task-checkbox:checked + .checkbox-box .checkbox-mark { display: block; }
  ...
  .delete-btn:hover { color: var(--accent); transform: scale(1.2) rotate(10deg); }
        ...
        <div className="todo-wrap">
          ...
          <div className="todo-header">
            <div>
              ...
              <h1 className="todo-title">To<span>·</span>Do</h1>
          ...
          {tasks.length > 0 && (
            <div className="task-count-row">
              <span className="task-count-label">{done}/{tasks.length} done</span>
              <span className="task-count-badge">{tasks.length - done} left</span>
            </div>
          )}
            ...
            <ul className="task-list">
              {tasks.map((task, i) => (
                <li key={task.id} className={`task-item${task.completed ? ' done' : ''}`}>
                  ...
                  <button onClick={() => deleteTask(task.id)} className="delete-btn" aria-label="Delete task">
